import { type Simplify, type SanitizedModelShape, type ModelConfig, type SanitizedModelSchema, DataType, SchemaType } from "@genseki/react";
 ...
 */
function model<const TShape extends SanitizedModelShape, const TConfig extends ModelConfig>(shape: TShape, config: TConfig): SanitizedModelSchema<TShape, TConfig> {
    return { config, shape };
}
